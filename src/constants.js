...
export const IMG__MENU_ITEM_CDN_URL = "https://res.cloudinary.com/swiggy/image/upload/fl_lossy,f_auto,q_auto,w_208,h_208,c_fit/";

export const API_URL4 = CORS_PROXY_URL + "/dapi/restaurants/list/v5?page_type=DESKTOP_WEB_LISTING&lat=22.814794130574803&lng=86.09871324151756";

export const API_URL3 = CORS_PROXY_URL + "/dapi/restaurants/list/v5?pageType=SEE_ALL&page_type=DESKTOP_SEE_ALL_LISTING&";

export const API_URL = CORS_PROXY_URL + "/dapi/restaurants/list/v5?page_type=DESKTOP_WEB_LISTING&";

export const API_URL2 = CORS_PROXY_URL + "dapi/restaurants/list/v5?lat=20.351841&lng=85.805154&page_type=DESKTOP_WEB_LISTING";

export const FETCH_MENU_URL = CORS_PROXY_URL + "/dapi/menu/pl?page-type=REGULAR_MENU&complete-menu=true&lat=22.8235&lng=86.2304589&submitAction=ENTER&restaurantId=";

export const GITHUB_LINK = "https://github.com/chinmay021";

export const GMAIL_LINK = "mailto:chinmaykumar021@gmail.com";

export const LINKEDIN_LINK = "https://www.linkedin.com/in/chinmay-kumar-950754144/";
